...
const start = async () => {
    ...
    if (connection === 'connecting') {
        console.log(color('[SYS]', 'red'), color(moment().format('DD/MM/YY HH:mm:ss'), 'white'), color(`${package.name} is Authenticating...`, 'blue'));
    } else if (connection === 'close') {
        const log = msg => console.log(color('[SYS]', 'red'), color(moment().format('DD/MM/YY HH:mm:ss'), 'white'), color(msg, 'blue'));
